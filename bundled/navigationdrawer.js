...
`;
  ...
  /**
    ...
    * SPDX-License-Identifier: Apache-2.0
    */
  const styles$2 = i$2 `.md3-navigation-drawer-modal{background-color:var(--_container-color);border-radius:var(--_container-shape);height:var(--_container-height)}.md3-navigation-drawer-modal.md3-navigation-drawer-modal--opened{inline-size:var(--_container-width)}.md3-navigation-drawer-modal .md3-navigation-drawer-modal__slot-content{min-inline-size:var(--_container-width);max-inline-size:var(--_container-width)}/*# sourceMappingURL=shared-styles.css.map */
`;
  ...
  MdNavigationDrawerModal.styles = [styles$2, styles$3];
  MdNavigationDrawerModal = __decorate([
      e$5('md-navigation-drawer-modal')
...
`;
  ...
  MdNavigationDrawer.styles = [styles$2, styles];
  MdNavigationDrawer = __decorate([
      e$5('md-navigation-drawer')
  ], MdNavigationDrawer);
