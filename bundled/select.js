(function () {
  ...
  ***************************************************************************** */
   ...
   */
  const e$8 = e => n => {if (typeof n === "function") {return ((e, n) => {if (!customElements.get(e)){customElements.define(e, n);}return n;})(e, n);} else {return ((e, n) => {const { kind: t, elements: s } = n;return {kind: t,elements: s,finisher(n) {if (!customElements.get(e)){customElements.define(e, n);}}};})(e, n);}};
...
`;
  ...
  MdFilledField.styles = [styles$f, styles$g];
...
`;
  ...
  /**
    ...
    * SPDX-License-Identifier: Apache-2.0
    */
  const styles$8 = i$4 `:host{color:unset;min-width:210px}.field{cursor:default;outline:none}.select{position:relative}.field,.select,md-menu{min-width:100%;max-width:inherit}.field,.select{width:100%}:host{display:inline-flex}.label{width:100%}:host([disabled]){pointer-events:none}/*# sourceMappingURL=shared-styles.css.map */
`;
  ...
  MdFilledSelect.styles = [styles$8, styles$9, styles$h];
...
`;
  ...
  MdOutlinedField.styles = [styles$f, styles$6];
...
`;
  ...
  MdOutlinedSelect.styles = [styles$8, styles$5, styles$7];
