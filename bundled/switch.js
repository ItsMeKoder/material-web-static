...
`;
  ...
  class Switch extends s {
      ...
      <button
        id="switch"
        type="button"
        class="switch ${o(this.getRenderClasses())}"
        role="switch"
...
`;
  ...
  MdSwitch.styles = [styles, styles$3];
  MdSwitch = __decorate([
      e$5('md-switch')
  ], MdSwitch);
