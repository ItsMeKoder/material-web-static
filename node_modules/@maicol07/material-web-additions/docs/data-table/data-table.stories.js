...
export const WithFilterTextField = {
    render: (args) => html `
    <md-data-table
      aria-label="Dessert calories"
      ?paginated="${args.paginated}"
...
export const WithSorting = {
  ...
  `,
    parameters: {
        docs: {
            description: {
                story: 'Data table with some sortable columns. Enabled when the `sortable` attribute is added to a column. You can control the sort direction via the `sortedDescending` attribute.',
            },
        },
    },
};
export const WithSortingAndFilter = {
    render: (args) => html `
    <md-data-table
      aria-label="Dessert calories"
      ?paginated="${args.paginated}"
  ...
  `,
    parameters: {
        docs: {
            description: {
                story: 'Data table with some sortable and filterable columns. Enabled when the `sortable` and `filterable` attributes are added to a column.',
            },
        },
    },
};
