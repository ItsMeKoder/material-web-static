...
export function getMarkup() {
    return Object.entries(components).map(([slug, details]) => {
        ...
        return (
        // @ts-ignore
        _jsxs("md-outlined-card", { onClick: component.released ? linkTo(component.docsLink ?? `components/${component.name}`) : undefined, clickable: component.released ? 'true' : undefined, children: [_jsx("img", { src: component.image, alt: component.name }), _jsx("div", { className: "component-card__header", children: _jsxs("div", { className: "components-card-header", children: [_jsx("div", { className: "demo-card__title components-card-header-title", children: _jsxs("span", { className: "components-card-header-title-text", children: [component.name, _jsxs("code", { className: "components-card-header-title-slug", children: ["md-", slug] })] }) }), _jsxs("div", { className: "demo-card__subtitle", children: [_jsx("span", { className: "components-card-subtitle", children: component.description }), !component.released && (_jsxs(_Fragment, { children: [_jsx("br", {}), _jsx("br", {}), _jsxs("small", { className: "components-card-status", children: ["Status: ", _jsx("a", { target: "_blank", href: component.status.link, children: component.status.text }), " ", component.status.afterText] })] }))] })] }) }), component.actions && Object.entries(component.actions).map(([id, action]) => (_jsx("a", { href: action.link, target: "_blank", className: "mwa-card-action", title: action.title, slot: "icon", children: _jsx("md-standard-icon-button", { "aria-label": action.title, children: _jsx("md-icon", { children: action.icon }) }) }, id)))] }, slug));
    });
}
